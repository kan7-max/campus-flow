...
These steps change external/public state and should only be done after explicit maintainer confirmation:

1. Create a new empty public GitHub repository.
2. Push from the clean export directory to that new repository.
3. Confirm the GitHub profile is public.
4. Enable GitHub secret scanning and Dependabot alerts for the public repository.
5. Set branch protection so checks are required before merging.
6. Fill the OpenAI form using the clean public repository URL and the OpenAI Organization ID.
