...
try {
  ...
  $secretPattern = '([s]k-[A-Za-z0-9_-]{20,}|[g]hp_[A-Za-z0-9_]{20,}|[g]ithub_pat_[A-Za-z0-9_]{20,}|[S]UPABASE_SERVICE_ROLE_KEY=\S+|[G]OOGLE_CLIENT_SECRET=\S+|[O]PENAI_API_KEY=\S+|[W]EB_PUSH_PRIVATE_KEY=\S+|[C]RON_SECRET=\S+|[A-Z]:\\Users\\[A-Za-z0-9._-]+|[O]BSIDIAN_VAULT_PATH=\S+)'
